...
while true; do
    ...
    "$SCRIPT_DIR/opencode.sh" "Execute the github-task-handler skill and github-commend-handler skill to fetch and process pending issues directly. Follow the standard steps to submit the solutions. Consulting with R&D for confirmation is strictly prohibited."
